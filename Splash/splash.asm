...
.open "arm9.bin", "arm9mod.bin",0x2000000
.arm
...
fade_in:
ldr r1,=credits_palette_cima
ldr r4,=credits_palette_baixo
mov r2, #0x05000000
orr r8, r2, #0x400
mov r3, #0x0
in_set:
...
credits_image:
.import "splash_c2.raw"

credits_palette_cima:
.import "paleta_cima.raw"
credits_palette_baixo:
.import "paleta_baixo.raw"
